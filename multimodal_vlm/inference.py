...
def test_inference(model: PaliGemmaForConditionalGeneration,
    ...
    pixel_value = model_inputs["pixel_value"]
    ...
    generated_token = torch.cat(generated_token, dim=-1)
    decoded = processor.tokenizer.decode(generated_token, skip_special_tokens=True)
